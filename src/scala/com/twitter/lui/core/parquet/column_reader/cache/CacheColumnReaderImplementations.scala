...
final case class BooleanColumnReader(writerVersion: ParsedVersion,
                                     path: ColumnDescriptor,
                                     pageReader: PageReader,
                                     maxDefLvl: Int,
                                     maxRepLvl: Int)
    extends CacheColumnReader(writerVersion, path, pageReader, maxDefLvl, maxRepLvl) {
  private[this] lazy val dict: Array[Boolean] =
...
final case class IntColumnReader(writerVersion: ParsedVersion,
                                 path: ColumnDescriptor,
                                 pageReader: PageReader,
                                 maxDefLvl: Int,
                                 maxRepLvl: Int)
    extends CacheColumnReader(writerVersion, path, pageReader, maxDefLvl, maxRepLvl) {
  private[this] lazy val dict: Array[Int] =
    if (dictionary == null) null
    else {
      val maxId = dictionary.getMaxId
...
final case class LongColumnReader(writerVersion: ParsedVersion,
                                  path: ColumnDescriptor,
                                  pageReader: PageReader,
                                  maxDefLvl: Int,
                                  maxRepLvl: Int)
    extends CacheColumnReader(writerVersion, path, pageReader, maxDefLvl, maxRepLvl) {
  private[this] lazy val dict: Array[Long] =
    if (dictionary == null) null
    else {
      val maxId = dictionary.getMaxId
...
final case class DoubleColumnReader(writerVersion: ParsedVersion,
                                    path: ColumnDescriptor,
                                    pageReader: PageReader,
                                    maxDefLvl: Int,
                                    maxRepLvl: Int)
    extends CacheColumnReader(writerVersion, path, pageReader, maxDefLvl, maxRepLvl) {
  private[this] lazy val dict: Array[Double] =
    if (dictionary == null) null
    else {
      val maxId = dictionary.getMaxId
...
final case class StringColumnReader(writerVersion: ParsedVersion,
                                    path: ColumnDescriptor,
                                    pageReader: PageReader,
                                    maxDefLvl: Int,
                                    maxRepLvl: Int)
  ...
  private[this] lazy val dict: Array[StringBinaryContainer] =
    if (dictionary == null) null
    else {
      val maxId = dictionary.getMaxId
  ...
  private[this] def innerRead(): StringBinaryContainer =
    try {
      if (!dictionaryActive)
