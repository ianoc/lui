...
final case class BooleanColumnReader(writerVersion: ParsedVersion,
                                     ...
                                     maxDefLvl: Int,
                                     maxRepLvl: Int)
    extends NonCacheColumnReader(writerVersion, path, pageReader, maxDefLvl, maxRepLvl) {
...
final case class StringColumnReader(writerVersion: ParsedVersion,
  ...
  private[this] lazy val stringDict: Array[String] =
    if (dictionary == null) null
    else {
      val maxId = dictionary.getMaxId
  ...
  private[this] lazy val bbDict: Array[ByteBuffer] =
    if (dictionary == null) null
    else {
      val maxId = dictionary.getMaxId
